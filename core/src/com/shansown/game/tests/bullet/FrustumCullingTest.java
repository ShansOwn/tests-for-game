...
public class FrustumCullingTest extends BaseBulletTest {
    ...
    public static Model createFrustumModel (final Vector3... p) {
        return ModelBuilder.createFromMesh(new float[]{p[0].x, p[0].y, p[0].z, 0, 0, 1, p[1].x, p[1].y, p[1].z, 0, 0, 1, p[2].x,
                        ...
                        p[7].z, 0, 0, -1},// far
                new VertexAttribute[]{new VertexAttribute(VertexAttributes.Usage.Position, 3, "a_position"),
                        new VertexAttribute(VertexAttributes.Usage.Normal, 3, "a_normal")}, new short[]{0, 1, 1, 2, 2, 3, 3, 0, 4, 5, 5, 6, 6, 7, 7, 4, 0, 4,
